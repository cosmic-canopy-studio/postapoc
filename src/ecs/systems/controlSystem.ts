  ...
  private handleAction(action: GameAction, state: boolean) {
    ...
    switch (action) {
      ...
      case GameAction.MoveDown:
        EventBus.emit("move", { action: MoveDirections.DOWN, state, entity: this.player });
        break;
      case GameAction.MoveLeft:
        EventBus.emit("move", { action: MoveDirections.LEFT, state, entity: this.player });
        break;
      case GameAction.MoveRight:
        EventBus.emit("move", { action: MoveDirections.RIGHT, state, entity: this.player });
        break;
